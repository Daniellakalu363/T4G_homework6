...
function hideTexttwo(){
    let textVanishtwo=document.getElementById("african");
    textVanishtwo.style.display="none";
    let rerevealtwo=document.getElementById("readthree");
    rerevealtwo.style.display="flex";
    let buttonVanishtwo=document.getElementById("lesstwo");
    buttonVanishtwo.style.display="none";
}
let vanishtwo=document.getElementById("lesstwo");
vanishtwo.addEventListener("click",hideTexttwo);


// African GardenEggs readmore
function showThree(){
...
function hideTextthree(){
    let textVanishthree=document.getElementById("fresh");
    textVanishthree.style.display="none";
    let rerevealthree=document.getElementById("readfour");
    rerevealthree.style.display="flex";
    let buttonVanishthree=document.getElementById("lessthree");
    buttonVanishthree.style.display="none";
}
let vanishthree=document.getElementById("lessthree");
vanishthree.addEventListener("click",hideTextthree);
...
function hideTextfour(){
    let textVanishfour=document.getElementById("green");
    textVanishfour.style.display="none";
    let rerevealfour=document.getElementById("readfive");
    rerevealfour.style.display="flex";
    let buttonVanishfour=document.getElementById("lessfour");
    buttonVanishfour.style.display="none";
}
let vanishfour=document.getElementById("lessfour");
vanishfour.addEventListener("click",hideTextfour);
...
function hideTextsix(){
    let textVanishsix=document.getElementById("wood");
    textVanishsix.style.display="none";
    let rerevealsix=document.getElementById("readseven");
    rerevealsix.style.display="flex";
    let buttonVanishsix=document.getElementById("lesssix");
    buttonVanishsix.style.display="none";
}
let vanishsix=document.getElementById("lesssix");
vanishsix.addEventListener("click",hideTextsix);
...
function hideTextseven(){
    let textVanishseven=document.getElementById("seed");
    textVanishseven.style.display="none";
    let rerevealseven=document.getElementById("readeight");
    rerevealseven.style.display="flex";
    let buttonVanishseven=document.getElementById("lessseven");
    buttonVanishseven.style.display="none";
}
let vanishseven=document.getElementById("lessseven");
vanishseven.addEventListener("click",hideTextseven);
